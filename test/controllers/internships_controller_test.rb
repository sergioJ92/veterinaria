...
class InternshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create internship" do
    assert_difference('Internship.count') do
      post internships_url, params: { internship: { deail: @internship.deail, dischargeDate: @internship.dischargeDate, intership_date: @internship.intership_date, pet_id: @internship.pet_id } }
    end
  ...
  test "should update internship" do
    patch internship_url(@internship), params: { internship: { deail: @internship.deail, dischargeDate: @internship.dischargeDate, intership_date: @internship.intership_date, pet_id: @internship.pet_id } }
