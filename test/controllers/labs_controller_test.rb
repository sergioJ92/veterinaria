...
class LabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post labs_url, params: { lab: { description: @lab.description, name: @lab.name, pet_id: @lab.pet_id, type: @lab.type } }
    end
  ...
  test "should update lab" do
    patch lab_url(@lab), params: { lab: { description: @lab.description, name: @lab.name, pet_id: @lab.pet_id, type: @lab.type } }
